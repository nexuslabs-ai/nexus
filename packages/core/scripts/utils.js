...
const FIELD_ERROR_BOUNDARY_SELECTORS = [
  ...
  "[data-slot='multi-select-trigger'][aria-invalid='true']",
...
const FIELD_DISABLED_BOUNDARY_SELECTORS = [
  ...
  "[data-slot='multi-select-trigger'][data-variant='default']:disabled",
...
const FIELD_ERROR_FOCUS_RING_SELECTORS = [
  ...
  "[data-slot='multi-select-trigger'][class~='nx:aria-invalid:focus-visible:outline-focus-error'][aria-invalid='true']:focus-visible",
