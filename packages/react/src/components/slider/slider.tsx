    ...
    >
      ...
      {Array.from({ length: values.length }, (_, index) => (
        <SliderPrimitive.Thumb
          ...
          aria-labelledby={ariaLabelledby}
          aria-invalid={ariaInvalid}
          className="nx:block nx:size-4 nx:shrink-0 nx:pointer-coarse:after:absolute nx:pointer-coarse:after:-inset-2 nx:rounded-full nx:border-default nx:border-border-primary nx:bg-background nx:transition-colors nx:focus-visible:outline-2 nx:focus-visible:outline-focus-default nx:focus-visible:outline-offset-(--focus-offset) nx:aria-invalid:focus-visible:outline-focus-error"
        />
      ))}
    </SliderPrimitive.Root>
  );
