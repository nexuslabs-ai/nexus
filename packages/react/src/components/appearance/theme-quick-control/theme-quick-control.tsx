        ...
        {BASE_TONE_OPTIONS.map((option) => {
          ...
          return (
            <button
              ...
              aria-pressed={active}
              title={option.label}
              className="nx:hover:bg-background-hover nx:focus-visible:outline-focus-default nx:relative nx:flex nx:size-9 nx:items-center nx:justify-center nx:rounded-full nx:transition-colors nx:after:absolute nx:after:-inset-1 nx:focus-visible:outline-2"
            >
              <span
                className={cn(
