...
function badgeShapeClasses(
  ...
  if (isNumber)
    return `${badgeMinSquareWidth} nx:rounded-full nx:px-1.5 nx:typography-label-caps nx:tabular-nums`;
  if (isIconOnly) return `${badgeMinSquareWidth} nx:p-0`;
