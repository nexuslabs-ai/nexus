        ...
        {Array.from({ length: 20 }, (_, row) => (
          <div key={row} className="nx:flex nx:gap-2 nx:py-1">
            {Array.from({ length: 15 }, (_, col) => (
              <div
                key={col}
                className="nx:flex nx:size-12 nx:shrink-0 nx:items-center nx:justify-center nx:bg-muted nx:typography-label-small nx:text-muted-foreground"
              >
                {row * 15 + col}
              </div>
            ))}
            ...
            {Array.from({ length: 12 }, (_, row) => (
              <div key={row} className="nx:flex nx:gap-2 nx:py-1">
                {Array.from({ length: 10 }, (_, col) => (
                  <div
                    key={col}
                    className="nx:flex nx:size-10 nx:shrink-0 nx:items-center nx:justify-center nx:bg-muted nx:typography-label-small nx:text-muted-foreground"
                  >
                    {row * 10 + col}
                  </div>
                ))}
