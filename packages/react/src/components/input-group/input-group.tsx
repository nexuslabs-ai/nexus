...
const inputGroupVariants = cva(
  [
    'nx:group/input-group nx:relative nx:flex nx:box-border nx:w-full nx:min-w-0 nx:items-center nx:rounded-md nx:border-default nx:transition-field',
...
function InputGroupInput({ className, ...props }: InputGroupInputProps) {
  return (
    <Input
      ...
      className={cn(
        'nx:flex-1 nx:rounded-none nx:border-0 nx:bg-transparent nx:enabled:hover:bg-transparent nx:disabled:bg-transparent nx:focus-visible:outline-none',
        className
      )}
      {...props}
    />
