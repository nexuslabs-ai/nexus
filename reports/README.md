...
- ⚠ **Unbuilt** — describes a forward-looking architecture that is **not implemented**. Reading it as current behavior will mislead; these carry an inline banner.
...
| [`spacing-architecture-fe-brief.html`](spacing-architecture-fe-brief.html)   | Spacing architecture FE brief (two-tier, per-mode)                                       | ⚠ **Unbuilt** — describes the not-yet-built spacing system; see [`spacing-tokens.md`](../.claude/rules/spacing-tokens.md) banner. Tracked by #117–#128 |
| [`spacing-token-architecture.html`](spacing-token-architecture.html)         | Spacing token architecture (multi-mode at the token level)                               | ⚠ **Unbuilt** — same architecture; tracked by #117–#128                                                                                                |
| [`spacing-tokens-component-guide.html`](spacing-tokens-component-guide.html) | Per-component guide for role-named spacing utilities                                     | ⚠ **Unbuilt** — the role utilities don't exist yet; tracked by #117–#128                                                                               |
...
| [`audit-report.html`](audit-report.html)                                     | Point-in-time full-repo audit                                                            | Historical — stale snapshot (May 2026)                                                                                                                 |
