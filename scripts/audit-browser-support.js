...
export const FEATURE_POLICIES = Object.freeze([
  ...
  },
  {
    ...
    guide: 'css',
    note: 'Firefox 113-120 sits below support, so rules keyed off :has() do not apply there. Keep interaction and semantics independent of it, and give any non-cosmetic loss a fallback under @supports not (selector(:has(*))).',
  },
  {
    id: 'color-scheme',
    name: 'color-scheme',
  ...
  },
  {
    ...
    guide: 'css',
    note: 'Firefox 121 is above the 113 floor. :has() in a non-forgiving position self-invalidates, so the unstyled path must be the acceptable fallback; no @supports gate is required.',
  },
  {
