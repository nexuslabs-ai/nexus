...
- Calendar and DatePicker selected days, which take `rounded-md` or
  `rounded-none` from their range position and week edge. Unselected days and
  the month navigation buttons follow the override.
