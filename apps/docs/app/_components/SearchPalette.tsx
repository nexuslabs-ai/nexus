  ...
  return (
    <>
      <button
        ...
        className="nx:hidden nx:lg:flex nx:items-center nx:gap-2 nx:px-3 nx:py-1 nx:typography-label-small nx:text-nav-muted-foreground nx:border nx:border-nav-border nx:rounded-sm nx:transition-[color,background-color,border-color] nx:hover:bg-nav-item-hover nx:hover:text-nav-foreground nx:focus-visible:outline-2 nx:focus-visible:outline-focus-default nx:focus-visible:outline-offset-2"
      >
        Search
