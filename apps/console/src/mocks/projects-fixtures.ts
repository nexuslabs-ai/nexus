...
export const ISSUES: (Issue & { description: string })[] = [
  ...
  },
  {
    ...
    updatedAt: '2026-06-01',
    description:
      'The focus ring should follow the active primary accent token, use hard field/button treatments, and keep a high-contrast outline fallback for forced-colors users.',
  },
  {
    id: 'i-11',
    key: 'ATL-111',
