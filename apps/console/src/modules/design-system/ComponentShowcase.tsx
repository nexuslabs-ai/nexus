          ...
          <div className="nx:space-y-6">
            ...
            <div className="nx:grid nx:grid-cols-2 nx:gap-6">
              ...
              <div className="nx:space-y-2">
                ...
                <div className="nx:flex nx:flex-wrap nx:gap-4">
                  <code className="nx:typography-code-block nx:bg-muted nx:px-2 nx:py-1">
                    const x = 42;
                  </code>
                  <code className="nx:typography-code-inline nx:bg-muted nx:px-1.5 nx:py-0.5">
                    inline
                  </code>
                </div>
              </div>
          ...
          <div className="nx:space-y-4">
            <div>
              ...
              <div className="nx:flex nx:flex-wrap nx:gap-3 nx:mt-2">
                <div className="nx:border nx:border-border-default nx:px-4 nx:py-2 nx:typography-label-default">
                  default
                </div>
                <div className="nx:border-thick nx:border-border-default nx:px-4 nx:py-2 nx:typography-label-default">
                  thick
                </div>
              </div>
            </div>
            <div>
              ...
              <div className="nx:flex nx:flex-wrap nx:gap-3 nx:mt-2">
                <div className="nx:border-2 nx:border-border-default nx:px-4 nx:py-2 nx:typography-label-default">
                  Default
                </div>
                <div className="nx:border-2 nx:border-border-primary nx:px-4 nx:py-2 nx:typography-label-default">
                  Primary
                </div>
                <div className="nx:border-2 nx:border-border-success nx:px-4 nx:py-2 nx:typography-label-default">
                  Success
                </div>
                <div className="nx:border-2 nx:border-border-error nx:px-4 nx:py-2 nx:typography-label-default">
                  Error
                </div>
                <div className="nx:border-2 nx:border-border-information nx:px-4 nx:py-2 nx:typography-label-default">
                  Info
                </div>
              </div>
            </div>
