          ...
          <div className="nx:space-y-4">
            ...
            <div>
              ...
              <div className="nx:flex nx:flex-wrap nx:gap-3 nx:mt-2">
                ...
                <div className="nx:border-2 nx:border-primary-border nx:rounded nx:px-4 nx:py-2 nx:typography-label-default">
                  Primary
                </div>
                <div className="nx:border-2 nx:border-success-border nx:rounded nx:px-4 nx:py-2 nx:typography-label-default">
                  Success
                </div>
                <div className="nx:border-2 nx:border-error-border nx:rounded nx:px-4 nx:py-2 nx:typography-label-default">
                  Error
                </div>
                <div className="nx:border-2 nx:border-information-border nx:rounded nx:px-4 nx:py-2 nx:typography-label-default">
                  Info
                </div>
              </div>
            </div>
