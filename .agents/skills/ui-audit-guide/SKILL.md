...
Before testing, read available design references: the `.claude/rules/` directory (especially `shadcn-divergences.md`), and design tokens in `packages/core/tokens/`. Skip any that don't apply.
