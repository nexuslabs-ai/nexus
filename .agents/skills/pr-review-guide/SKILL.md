...
| [project-stage.md](../../../.claude/rules/project-stage.md)                                 | Flag shims and feature flags; breaking published-API changes need a migration guide + `minor` changeset below 1.0   |
