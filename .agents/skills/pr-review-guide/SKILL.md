...
| [no-environment-branching.md](../../../.claude/rules/no-environment-branching.md)           | Flag OS, browser, or input-device queries (`forced-colors`, `@supports`, `prefers-reduced-*`, `pointer:`) |
