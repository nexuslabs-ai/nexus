...
| [ripple-effect.md](../../../.claude/rules/ripple-effect.md)                                 | Plan must account for callers, callees, and adjacent code consistency             |
| [composition-over-render-props.md](../../../.claude/rules/composition-over-render-props.md) | Component shape decisions: `children` or per-mode split, never render callbacks   |
| [useeffect-escape-hatch.md](../../../.claude/rules/useeffect-escape-hatch.md)               | Design data flow so effects sync with external systems, not React state           |
| [project-stage.md](../../../.claude/rules/project-stage.md)                                 | Pre-production: no backcompat, no shims, no feature flags — change code in place  |
