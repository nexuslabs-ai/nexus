...
1. Read available design references (root `CLAUDE.md`, package-level `CLAUDE.md`s, design tokens in `packages/core/tokens/`)
...
1. State the design intent explicitly (product, user, north star) — infer from available design references (root + package-level `CLAUDE.md`s, design tokens)
