...
- _Tempted by a backcompat shim / deprecation / feature flag?_ → delete or rename internals in place; this is pre-production. Published token renames need a migration guide + breaking changeset. (`project-stage.md`)
