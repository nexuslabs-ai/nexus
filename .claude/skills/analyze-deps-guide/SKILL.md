...
| Rule                                             | Purpose                                                                                                               |
| ------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------- |
| [project-stage.md](../../rules/project-stage.md) | Prefer clean upgrades over shims; breaking published-API changes need a migration guide + `minor` changeset below 1.0 |
