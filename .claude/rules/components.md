...
| `Combobox`                    | `sm/default/lg`: inherits `InputGroup` `nx:h-8` / `nx:h-10` / `nx:h-12`                                                                           | Inherits `InputGroup` input/addon spacing                                              | Layout-controlled `nx:w-full`; popover width tracks trigger                   |
| `MultiSelectTrigger`          | `sm/default/lg`: `nx:min-h-8` / `nx:min-h-10` / `nx:min-h-12`; chips may wrap the row when open                                                   | `nx:px-2` / `nx:px-2.5` / `nx:px-3`, `nx:gap-2`                                        | Layout-controlled `nx:w-full`; popover width tracks trigger                   |
