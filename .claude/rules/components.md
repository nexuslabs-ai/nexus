...
- **Notion-style focus.** Inputs, textareas, selects, OTP slots, and input groups keep their real border transparent on focus and paint the visible focus edge with two 1px shadows: one inset and one outside. Buttons get a 2px surface gap plus a 2px outer primary ring. Other keyboard-focusable controls get a hard 2px primary ring.
