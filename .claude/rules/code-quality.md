...
- `project-stage.md` — pre-production internals change in place, no shims or flags; published token names are a public API, so renames need a migration guide + breaking changeset
