...
- `project-stage.md` — pre-production internals change in place, no shims or flags; the npm-published surface is a public API, so breaking changes need a migration guide + a `minor` changeset while below 1.0
