...
| `ring-offset-background` | `nx:focus-visible:outline-offset-(--focus-offset)` | Focus offset (tokenised `--focus-offset`, 2px)  |
| `focus-visible:ring-2`   | `nx:focus-visible:outline-2`                       | Focus outline width                             |
